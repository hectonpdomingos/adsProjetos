...
<div class="jumbotron">
  <div class="container">
    ...
    <div class="row">
    <form class="form-inline" action="./api/funcoes.php" method="post" name="pesquisaForm"><!--Campo de pesquise Cliente -->
...
<br> <!--Adicione  Duas linhas abaixo -->
          ...
          <form id="controleCliente" action="./api/funcoes.php" method="post">
